...
TOKEN = '8221831967:AAGaVkn259zFu1f-MUjJU-hfcRPZBpGIy94' # Твой токен, убедись, что он правильный
...
MESSAGES = {
    ...
    'ask_players_count': "Напишите желаемое количество игроков (от 4 до 10).", # Обновлено
    'invalid_max_players': "Неверное количество игроков. Введите число от 4 до 10.", # Обновлено
    ...
    'mafia_win': "Игра окончена. Мафия победила! Осталось {citizen_count} мирных жителей.", # Обновлено
...
def check_win_condition(room_id):
    ...
    # Условие победы Мафии: количество мафиози >= количество мирных
    ...
    # Условие победы Мирных жителей: мафии нет
    ...
    # Если остались только мертвые игроки или нет живых игроков
...
def process_max_players_count(message):
    try:
        ...
        if not (4 <= max_players <= 10): # Обновлены лимиты
            try:
